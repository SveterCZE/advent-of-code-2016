def get_instructions():
    ...
    for line in f:
        ...
        if temp_line[0] == "bot":
            ...
            insertion_instructions.append(temp_line)
    for line in insertion_instructions:
        playground.bots_db[line[5]].insert_new_chip(int(line[1]))
    return playground
...
class Playground():
    ...
    def run_distributions(self):
        ...
        while True:
            ...
            high_value, low_value = distributing_bot.remove_value("H"), distributing_bot.remove_value("L")
